    ...
    <div class="w-full max-w-md">
        <div class="rounded-xl shadow-xl p-8 bg-white border border-gray-200">
            <div class="text-center mb-6">
                <h1 class="text-2xl font-bold mb-1">Modifier compte responsable</h1>
                <p class="text-sm">Mettez à jour les informations du responsable</p>
            </div>
            ...
            <!-- Formulaire -->
            <form action="{{ route('updateResponsable') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="matricule" name="matricule_respresp_obligatoire" required
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('updateTechnicien') }}" class="text-sm link">Modifier compte Technicien</a>
                </div>
