    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl shadow-2xl p-8 backdrop-blur-sm bg-opacity-90 border border-white border-opacity-20">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-indigo-600 mb-2">Créer un compte Responsable</h1>
            ...
            <!-- Formulaire -->
            <form action="{{ route('createResponsable') }}" method="POST" class="space-y-5">
                @csrf

                <!-- Matricule -->
                <div>
                    <label for="Matricule_resp" class="block text-sm font-medium text-gray-700 mb-1">Matricule</label>
                    <div class="relative">
                        <input type="text" name="Matricule_resp" id="Matricule_resp"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="Nom_resp" class="block text-sm font-medium text-gray-700 mb-1">Nom</label>
                        <input type="text" name="Nom_resp" id="Nom_resp"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                    ...
                    <div>
                        <label for="Prenom_resp" class="block text-sm font-medium text-gray-700 mb-1">Prénom</label>
                        <input type="text" name="Prenom_resp" id="Prenom_resp"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                ...
                <!-- CIN -->
                <div>
                    <label for="CIN_resp" class="block text-sm font-medium text-gray-700 mb-1">CIN</label>
                    <div class="relative">
                        <input type="text" name="CIN_resp" id="CIN_resp"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                ...
                <!-- Email -->
                <div>
                    <label for="Email_resp" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <div class="relative">
                        <input type="email" name="Email_resp" id="Email_resp"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                ...
                <div class="div_link_tech">
                    <a href="{{ route('createTechnicien') }}" class="text-sm text-indigo-600 hover:text-indigo-500 text-center" > Créer un compte Technicien </a>
                </div>
