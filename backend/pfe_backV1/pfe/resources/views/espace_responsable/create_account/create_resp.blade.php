...
<body>
    ...
    <div class="max-w-lg mx-auto mt-10 card">
        <h2 class="form-title">Créer un compte Responsable</h2>
        ...
        <form action="{{ route('createResponsable') }}" method="POST" class="grid grid-cols-1 gap-6">
            @csrf

            <div>
                <label for="Matricule_resp" class="block font-medium">Matricule</label>
                <input type="text" name="Matricule_resp" id="Matricule_resp" class="input-field w-full" required>
                @error('Matricule_resp')<div class="error-message">{{ $message }}</div>@enderror
            </div>

            <div>
                <label for="Nom_resp" class="block font-medium">Nom</label>
                <input type="text" name="Nom_resp" id="Nom_resp" class="input-field w-full" required>
                @error('Nom_resp')<div class="error-message">{{ $message }}</div>@enderror
            </div>

            <div>
                <label for="Prenom_resp" class="block font-medium">Prénom</label>
                <input type="text" name="Prenom_resp" id="Prenom_resp" class="input-field w-full" required>
                @error('Prenom_resp')<div class="error-message">{{ $message }}</div>@enderror
            </div>

            <div>
                <label for="CIN_resp" class="block font-medium">CIN</label>
                <input type="text" name="CIN_resp" id="CIN_resp" class="input-field w-full" required>
                @error('CIN_resp')<div class="error-message">{{ $message }}</div>@enderror
            </div>

            <div>
                <label for="Email_resp" class="block font-medium">Email</label>
                <input type="email" name="Email_resp" id="Email_resp" class="input-field w-full" required>
                @error('Email_resp')<div class="error-message">{{ $message }}</div>@enderror
            </div>
